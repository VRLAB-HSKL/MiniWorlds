...
/// </summary>
public class ResetPinsAndBallsLane1 : MonoBehaviour
    ...
    , IColliderEventPressExitHandler
{
    ...
    private readonly int LANE_ONE = 1;
    ...
    public void OnColliderEventPressUp(ColliderButtonEventData eventData)
    {
        ...
        {
            if (GameObject.Find("ResetButtonPinsAndBalls1").activeSelf == true) { GameObject.Find("GameController").GetComponent<Bowling>().resetBallsAndPins(LANE_ONE); }
        }
    }
