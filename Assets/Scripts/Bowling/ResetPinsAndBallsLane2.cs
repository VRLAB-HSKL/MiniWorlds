...
/// </summary>
public class ResetPinsAndBallsLane2 : MonoBehaviour
    ...
    , IColliderEventPressExitHandler
{
    ...
    private readonly int LANE_TWO = 2;
    ...
    public void OnColliderEventPressUp(ColliderButtonEventData eventData)
    {
        ...
        {
            if (GameObject.Find("ResetButtonPinsAndBalls2").activeSelf == true) { GameObject.Find("GameController").GetComponent<Bowling>().resetBallsAndPins(LANE_TWO); }
        }
    }
